...
The purpose of this project is to extract insights from survey data to discern the desires of those completing the survey where data exists is a columnar format
