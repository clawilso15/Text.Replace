...
dbeta4 <- function(x, min, max, shape1, shape2, gap = 0) {
    .Call(`_Text_Replace_dbeta4`, x, min, max, shape1, shape2, gap)
}
...
pbeta4 <- function(q, min, max, shape1, shape2, gap = 0) {
    .Call(`_Text_Replace_pbeta4`, q, min, max, shape1, shape2, gap)
}

#' @export
#' @rdname beta4
qbeta4 <- function(p, min, max, shape1, shape2) {
    .Call(`_Text_Replace_qbeta4`, p, min, max, shape1, shape2)
}
